...
3. On first run your wizard will auto-install from your repo. 
4. Any future wizard updates pushed via your repo will then be automatically installed.<br><br>
